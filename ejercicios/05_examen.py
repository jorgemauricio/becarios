...
# falta la posición de los valores
import numpy as np
matrix = np.array( [[20,1,20,8,6],[19,0,5,8,10],[9,8,9,0,12],[11,2,13,4,5],[4,3,18,1,3]])
print ('valor',matrix [0::].max())
print ('valor',matrix [1::].max())
print ('valor',matrix [2::].max())
print ('valor',matrix [3::].max())
print ('valor',matrix [4::].max())
